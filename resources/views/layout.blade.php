...
<ul class="sidebar-list">
    <li class="sidebar-list-item" onclick="navigateToPage('admindashboard')">
        <span class="material-icons-outlined">    dashboard  </span>Dashboard
    </li>
    <li class="sidebar-list-item" onclick="navigateToPage('product')">
        <span class="material-icons-outlined">  inventory_2  </span>Products
    </li>
    <li class="sidebar-list-item" onclick="navigateToPage('category')">
    ...
    <li class="sidebar-list-item" onclick="navigateToPage('admin/login')">
